...
import (
    ...
    "github.com/kernelhcy/ingo"
    _ "github.com/kernelhcy/wego/backends"
    _ "github.com/kernelhcy/wego/frontends"
...
func main() {
    ...
    selectedBackend := flag.String("backend", "caiyun.com", "`BACKEND` to be used")
    flag.StringVar(selectedBackend, "b", "caiyun.com", "`BACKEND` to be used (shorthand)")
